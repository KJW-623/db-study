...
select NVL (MAX(no)+1, 0)+1 from seq_test; -- 다음에 사용할 no값
...
select seq_seq_test_pk.currval from dual; --현재 seq값
...
select seq_seq_test_pk.nextval from dual; --으로 만들기
--다시 원상 복구
