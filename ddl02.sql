...
VALUES (1, 'name1', TO_DATE('202-02-02'));

select * from new_table3;

INSERT INTO new_table3
VALUES (2, null, TO_DATE('202-02-02'));

INSERT INTO new_table3 (no, birth)
VALUES (3, TO_DATE('202-02-02'));
...
INSERT INTO tt01
VALUES (2, null, SYSDATE); --NOT NULL이라서 불가
...
(
    ...
    birth DATE,
    score NUMBER(3) CONSTRAINT tt02_score_ck CHECK (score BETWEEN 0 AND 100), 
    pass VARCHAR2(2) CONSTRAINT tt02_pass_ck CHECK (pass IN ('Y', 'N'))
);
...
boolean True/False X 테이블에 저장불가
True/False
1/0
T/F
Y/N
